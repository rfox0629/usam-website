...
async function getDashboardData(): Promise<DashboardData> {
  ...
  const latestInquiries = [
    ...
    ...majorGiftInquiries.map((inquiry) => ({
      ...
      email: inquiry.email,
      href: `/admin/financial-freedom?type=major-gift&majorGift=${inquiry.id}`,
      id: inquiry.id,
      isNew: inquiry.status === "new",
...
function LatestInquiries({ inquiries }: { inquiries: DashboardInquiryItem[] }) {
  return (
    <section>
      <SectionHeader
        action={<ActionButton href="/admin/financial-freedom">Open Queue</ActionButton>}
        eyebrow="Review"
...
export default async function AdminDashboardPage() {
  ...
  const metrics = [
    ...
    { href: "/admin/financial-freedom?status=new", label: "New Inquiries", value: hasDataError ? "-" : formatMetric(data.newInquiries) },
        ...
        <section id="todays-work" className="scroll-mt-24">
          ...
          <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
            <WorkCard
              ...
              href="/admin/financial-freedom?status=new"
              title="New Inquiries"
            />
            <WorkCard
              action="Fix Now"
            ...
            <WorkCard
              ...
              href="/admin/financial-freedom?type=major-gift&status=new"
