...
const sections = [
  { id: "cover", label: "Introduction", num: "01" },
  { id: "who-i-am", label: "Who I Am", num: "02" },
  { id: "vision", label: "USA Missionaries", num: "03" },
  { id: "kitchen-table", label: "Kitchen Table", num: "04" },
  { id: "stewardship", label: "Stewardship & DOS", num: "05" },
  { id: "save-standard", label: "The SAVE Standard", num: "06" },
  { id: "contribution", label: "My Contribution", num: "07" },
  { id: "closing", label: "Discussion", num: "08" },
] as const;

const TRACK_HEIGHT = 340;

export function BoardBriefingSectionRail() {
  ...
  return (
    <nav
      ...
      className="no-print fixed right-4 top-1/2 z-40 hidden -translate-y-1/2 lg:block xl:right-7"
    >
      <div
