...
/**
 * Renders a real asset if one has been dropped in public/images/board-briefing/<id>.*,
 ...
 */
export function BoardBriefingMedia({
  alt,
  aspect = "wide",
  className = "",
  id,
  kind = "photo",
  subject,
}: BoardBriefingMediaProps) {
  const src = resolveBoardBriefingImage(id);
    ...
    >
      ...
      <div>
        ...
        <p
          ...
          title={`public/images/board-briefing/${id}.jpg`}
        >
          public/images/board-briefing/{id}.jpg
        </p>
      </div>
    </div>
  );
