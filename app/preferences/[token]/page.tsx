          ...
          {!subscriber ? (
            <div>
              ...
              <p className="mt-5 text-sm leading-7 text-stone-600">
                This preference link is no longer valid. Subscribe again to refresh your email settings.
              </p>
              <Link className="mt-6 inline-flex min-h-11 items-center rounded-md bg-[#C2A14E] px-5 text-sm font-semibold text-stone-950" href="/subscribe">
                Subscribe
              </Link>
            </div>
          ) : (
