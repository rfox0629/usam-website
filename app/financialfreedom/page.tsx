  ...
  return (
    <main className="min-h-screen bg-[#0D0D0D] text-stone-100">
      ...
      <section className="relative overflow-hidden px-6 pb-10 pt-24 md:pb-12 md:pt-28">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_18%_24%,rgba(194,161,78,0.10),transparent_28%),radial-gradient(ellipse_at_center,transparent_38%,#0D0D0D_100%)]" />
