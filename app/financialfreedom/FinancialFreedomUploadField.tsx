...
export function FinancialFreedomUploadField() {
  ...
  return (
    <div className="space-y-4">
      <label
        htmlFor="uploads"
        className="block rounded-2xl border border-dashed border-stone-300 bg-usam-white p-5 transition-colors hover:border-[#C2A14E]/70 md:p-6"
      >
        ...
        <input
          ...
          className="mt-5 block w-full cursor-pointer rounded-xl border border-stone-300 bg-white text-sm text-stone-700 shadow-sm file:mr-4 file:cursor-pointer file:border-0 file:bg-[#C2A14E] file:px-4 file:py-3 file:text-xs file:font-bold file:uppercase file:tracking-[0.16em] file:text-stone-950 hover:file:bg-[#C2A14E]"
