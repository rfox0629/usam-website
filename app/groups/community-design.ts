...
/* ------------------------------------------------------------------ *
 * USA Missionaries affiliation.
 *
 * USA-57 founder correction: every actual Group page and listing is part of
 * the DOS ecosystem and uses the DOS tokens above. The gold public card
 * treatment is retired. USA Missionaries now appears only as a subtle
 * affiliation / publisher label, not as a second visual system.
 * ------------------------------------------------------------------ */

/** Quiet publisher line: small logo + "A USA Missionaries Group". */
export const communityAffiliation =
  "inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.14em] text-[#64748B]";

/** Page-level header/footer rule used by the public Group surfaces. */
export const communityHairline = "border-[#EAF2FF]";

/** Neutral surface used inside cards for schedule and fact blocks. */
export const communityInsetPanel = "rounded-2xl bg-[#F8FBFF]";
