        ...
        <div className="flex flex-1 flex-col gap-6">
          ...
          {groups.length ? (
            ...
            <section className="rounded-lg border border-white/10 bg-[#111418] p-6 text-sm leading-6 text-white/65 shadow-[0_18px_48px_rgba(0,0,0,0.22)]">
              <p className="font-black text-white">No public Community yet.</p>
              <p className="mt-1 text-white/65">Community rhythms will appear here when they are ready to share publicly.</p>
            </section>
          )}
        </div>
