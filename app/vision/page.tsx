...
import { VisionMedia } from "./VisionMedia";
import { VisionMobileNav } from "./VisionMobileNav";
import { VisionPrintButton } from "./VisionPrintButton";
import { VisionScreenshotLightbox } from "./VisionScreenshotLightbox";
import { VisionSectionRail } from "./VisionSectionRail";
  ...
  return (
    ...
    >
      <div className="relative mx-auto max-w-6xl">
        <Eyebrow>USA Missionaries Vision Briefing</Eyebrow>
        <h1
  ...
  return (
    <Section id="kitchen-table">
      ...
      <div className="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <VisionMedia alt="Kitchen table conversation" id="kitchen-table-01" subject="A real kitchen-table conversation" />
        <VisionMedia alt="Kitchen table ministry moment" id="kitchen-table-02" subject="A kitchen-table or coffee-shop ministry moment" />
        <VisionMedia alt="Group prayer" id="group-prayer-01" subject="A group praying together" />
        <VisionMedia
...
function StewardshipSection() {
  const engagementSrc = resolveVisionImage("dos-engagement");
  const circlesSrc = resolveVisionImage("dos-circles");
  const meetingsSrc = resolveVisionImage("dos-meetings");
  ...
  return (
    <>
      ...
      <Section id="save-standard" variant="save">
        ...
        <VisionMedia alt="SAVE Standard website" className="mt-14" id="save-standard-home" subject="SAVE Standard homepage" />

        <div className="mt-4 grid gap-4 sm:grid-cols-2">
          <VisionMedia alt="Dirk and Julia Bond" id="dirk-julia" subject="Dirk and Julia Bond" />
          <VisionMedia alt="Dirk and Julia Bond" id="dirk-julia-portrait" subject="Dirk and Julia Bond" />
        </div>
  ...
  return (
    <Section id="closing">
      ...
      <p className="mt-10 text-xs leading-6 text-stone-600">
        Private vision briefing · USA Missionaries and SAVE are independent organizations · Not a fundraising or
        legal document.
      </p>
    </Section>
  );
