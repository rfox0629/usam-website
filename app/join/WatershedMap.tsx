 ...
 * south. Nothing is announced; the motion is small enough that it is noticed
 * after the map is, which is what the founder asked for.
 *
 * Everything is one gold tonal family, no second accent. Canvas 2D, no
 * dependencies, DPR aware, static layers cached to an offscreen canvas so each
 * frame only redraws the light. A single composed still frame under reduced
 * motion.
 */
