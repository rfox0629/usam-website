...
export default async function SystemV1Page({
  searchParams,
}: {
  ...
  const shouldOpenAccess = params.access === "1" || params.previewForm === "system_access_code";
      ...
      <section className="relative overflow-hidden border-b border-stone-900/80 px-4 pb-16 pt-28 sm:px-6 md:pb-20 md:pt-36">
        ...
        <div className="relative mx-auto grid max-w-6xl min-w-0 items-center gap-12 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="min-w-0 max-w-2xl">
            <BriefingLabel>System V1</BriefingLabel>
            <h1
            ...
            <WaitingListCTA
              ...
              sourcePage="/system/v1"
            />
            {hasAccess ? (
              <div className="mt-4">
                <AccessLogoutButton redirectTo="/system/v1">Exit System</AccessLogoutButton>
              </div>
            ) : null}
          </div>
