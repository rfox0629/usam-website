          ...
          <div className="flex min-h-full items-start justify-center pt-8 md:pt-12">
            <div className="relative w-full max-w-[840px]">
              <button
                ...
                className="absolute right-4 top-4 z-10 inline-flex h-10 w-10 items-center justify-center rounded-full border border-stone-300 bg-white text-xl leading-none text-stone-700 shadow-sm transition-colors hover:border-usam-gold hover:text-stone-950"
                onClick={closeModal}
                type="button"
              >
                &times;
