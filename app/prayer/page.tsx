...
const prayerRows = [
  { focus: "Kitchen Tables", status: "Covered" },
  { focus: "Missionary Couples", status: "Covered" },
  { focus: "Leaders", status: "Covered" },
  { focus: "Cities", status: "Covered" },
  { focus: "Government", status: "Covered" },
  { focus: "Finances", status: "Covered" },
] as const;
...
function PrayerCoverageBoard() {
  return (
    <div className="relative border border-stone-800/80 bg-[#0D0D0D]/95 shadow-[0_0_36px_rgba(0,0,0,0.45)]">
      ...
      <div className="relative border-b border-stone-800/70 px-4 py-4 md:px-5">
        <div className="flex items-center justify-between gap-4">
          <div className="flex min-w-0 items-center gap-2">
            <span className="h-2 w-2 rounded-full bg-usam-success shadow-[0_0_14px_rgba(15,157,118,0.38)]" />
            <span
      ...
      <div className="relative divide-y divide-stone-900/80">
        {prayerRows.map((row) => (
          <div key={row.focus} className="grid min-h-[62px] grid-cols-[1fr_auto] items-center gap-4 px-4 py-4 md:px-5">
            ...
            <span
              className="inline-flex rounded-sm border border-[rgba(15,157,118,0.24)] bg-[rgba(15,157,118,0.16)] px-2 py-1 text-[10px] uppercase tracking-[0.16em] text-usam-success"
              style={{ fontFamily: font.rajdhani }}
            >
              {row.status}
            </span>
  ...
  return (
    <main className="min-h-screen bg-[#0D0D0D] text-stone-100">
      ...
      <section className="relative overflow-hidden border-b border-stone-900/80 px-6 pb-14 pt-28 md:pb-20 md:pt-32">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_18%_18%,rgba(194,161,78,0.06),transparent_24%),linear-gradient(180deg,rgba(13,13,13,0.15),#0D0D0D_88%)]" />
      ...
      <section className="bg-[#0D0D0D] px-6 py-20 md:py-24">
