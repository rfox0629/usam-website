    ...
    <article className="group flex h-full flex-col overflow-hidden border border-stone-200 bg-white shadow-[0_24px_80px_rgba(13,13,13,0.08)] transition-all duration-300 hover:-translate-y-1 hover:border-[#C2A14E]/50 hover:shadow-[0_28px_90px_rgba(13,13,13,0.14)]">
      <div className="relative h-[250px] overflow-hidden bg-stone-950">
        {showImage && missionary.image ? (
          ...
          <div className="flex h-full items-center justify-center bg-[linear-gradient(135deg,#0D0D0D,#0D0D0D)] px-6 text-center">
            <div>
      ...
      <div className="flex flex-1 flex-col p-6 md:p-7">
        <p className="text-[11px] uppercase tracking-[0.22em] text-[#C2A14E]" style={{ fontFamily: font.rajdhani, fontWeight: 700 }}>
...
export function MissionaryDirectory({
  ...
  return (
    <>
      <div className="border border-stone-200 bg-white p-4 shadow-[0_24px_80px_rgba(13,13,13,0.08)] md:p-5">
        <div className="grid gap-4 lg:grid-cols-[1fr_auto] lg:items-center">
          ...
          <input
            ...
            className="min-h-12 w-full border border-stone-300 bg-white px-4 text-sm text-stone-950 outline-none transition-colors placeholder:text-stone-500 focus:border-[#C2A14E]"
          />
              ...
              <button
                ...
                className={`min-h-10 border px-4 text-[11px] uppercase tracking-[0.18em] transition-colors duration-300 ${
                  activeFilter === filter
                    ...
                    : "border-stone-300 bg-white text-stone-700 hover:border-[#C2A14E] hover:text-stone-950"
                }`}
                style={{ fontFamily: font.rajdhani, fontWeight: 700 }}
              >
                {filter}
