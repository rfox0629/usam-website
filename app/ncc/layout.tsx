...
// /ncc shares the exact admin_users/Supabase Auth gate as /admin — there is
// no separate NCC identity system. This layout only decides presentation of
// the denial states; access itself is decided by getAdminAuthorization().
function NccBlocked({ detail, showSignOut = false, title }: { detail: string; showSignOut?: boolean; title: string }) {
  return (
