...
import { generateWorkpaperAction } from "../actions";
...
export function WorkpapersPanel({
  ...
  const relevantWorkpapers = workpapers.filter((workpaper) => availableTypes.includes(workpaper.workpaperType));
              ...
              <div className="border border-stone-900 bg-[#050505] p-4" key={workpaper.id}>
                <div className="flex flex-wrap items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <AdminBadge tone="muted">{workpaper.reviewStatus}</AdminBadge>
                  </div>
                </div>
