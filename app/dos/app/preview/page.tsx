...
function buildDemoMeeting(meeting: DemoMeetingInput): DosAppMeeting {
  return {
    ...
    /* Production shape: no stored role. A fixture meeting that sets tableRole
       must also say tableRoleRecorded: true for the report to read it. */
...
function buildDosPreviewDemoData(options: DosPreviewDemoOptions = {}): DosAppData {
  const people: DosAppPerson[] = [
    ...
    /* USA-251: Dirk Bond is discipling Ryan. This mirrors the production
       record exactly: the Person carries the legacy summary "Mentor · Friend ·
       Exploring" with a structured role of Not active, and the direction
       comes from the My Record relationship (myRecord.mentorRelationships
       below). The report shows the direction and names the conflict. */
    {
      church: null,
      ...
      engagementLevel: "High",
      fieldVisibility: "primary",
      id: "demo-person-dirk-bond",
      lastActivityAt: daysAgoIso(9),
      name: "Dirk Bond",
      notes: "",
      phone: "918-555-0180",
      relationshipContext: "friend",
      relationshipType: "Mentor · Friend · Exploring",
      relationshipTypeValue: "new",
      roleInMyLife: "not_active",
      status: "active",
      updatedAt: daysAgoIso(9),
    },
    /* USA-251 classification scenarios (founder review, 2026-09-09), all with
       production-shaped legacy meetings that carry no stored role:
       - Marty: confirmed "They are discipling me" on the Person -> his legacy
         meeting is Time invested in me by rule 2.
       - Sam: the Person says "I am discipling them" but My Record also lists
         him as discipling me -> conflicting -> Direction unresolved.
       - Austin: no direction on the Person and none in My Record ->
         Direction unresolved. */
    {
      ...
      engagementLevel: "Medium",
      fieldVisibility: "primary",
      id: "demo-person-marty-vanderzanden",
      lastActivityAt: daysAgoIso(5),
      name: "Marty Vanderzanden",
      notes: "",
      phone: "",
      relationshipContext: "church",
      relationshipType: "Discipling me · Church · Exploring",
      relationshipTypeValue: "mentor",
    ...
    },
    {
      ...
      engagementLevel: "Medium",
      fieldVisibility: "primary",
      id: "demo-person-sam-lucas",
      lastActivityAt: daysAgoIso(5),
      name: "Sam Lucas",
      notes: "",
      phone: "",
      relationshipContext: "friend",
      relationshipType: "Discipling · Friend · Exploring",
      relationshipTypeValue: "discipling",
      roleInMyLife: "discipling_them",
      status: "active",
      updatedAt: daysAgoIso(5),
    },
    {
      ...
      engagementLevel: "Medium",
      fieldVisibility: "primary",
      id: "demo-person-austin-clifford",
      lastActivityAt: daysAgoIso(5),
      name: "Austin Clifford",
      notes: "",
      phone: "",
    ...
    // Kept from main: Tanner backs the Wednesday Men's Group Journey QA.
    {
      ...
      phone: "918-555-0174",
      relationshipContext: "church",
      /* USA-251: Ryan is discipling Tanner (the production role), so the
         Ryan → Tanner → Tanner's disciple beta chain reads correctly. */
  ...
  const meetingInputs = [
    ...
    /* USA-251 founder scenarios. Tanner: two recorded meetings and a check-in
       inside the last 30 days. Philip: one meeting logged without a start and
       end, so the report has a Partial row and a next action. Dirk: two
       meetings where Ryan was the one being discipled, and the next one
       already on the calendar. */
    {
      conversationFlowKey: "none",
      conversationResponses: {},
      date: daysAgoIso(7, 12),
      fieldPersonIds: ["demo-person-tanner-kent"],
      growthReflection: emptyGrowthReflection,
      id: "demo-meeting-tanner-kitchen-table",
      notes: "",
      participantNames: ["Tanner Kent"],
      recommendedResources: [],
      review: buildDemoReview(),
      scheduledEndAt: daysAgoIso(7, 14, 30),
      scheduledStartAt: daysAgoIso(7, 12),
      source: "table",
      title: "Kitchen table",
      type: "kitchen_table",
      updatedAt: daysAgoIso(7, 15),
    },
    {
      conversationFlowKey: "none",
      conversationResponses: {},
      date: daysAgoIso(20, 12),
      fieldPersonIds: ["demo-person-tanner-kent"],
      growthReflection: emptyGrowthReflection,
      id: "demo-meeting-tanner-discipleship",
      notes: "",
      participantNames: ["Tanner Kent"],
      recommendedResources: [],
      review: buildDemoReview(),
      scheduledEndAt: daysAgoIso(20, 14),
      scheduledStartAt: daysAgoIso(20, 12),
      source: "table",
      title: "Discipleship",
      type: "discipleship",
      updatedAt: daysAgoIso(20, 15),
    },
    {
      conversationFlowKey: "none",
      conversationResponses: {},
      date: daysAgoIso(16, 10),
      fieldPersonIds: ["demo-person-philip-saco"],
      growthReflection: emptyGrowthReflection,
      id: "demo-meeting-philip-no-time",
      notes: "",
      participantNames: ["Philip John Saco"],
      recommendedResources: [],
      review: buildDemoReview(),
    ...
    },
    {
      ...
      growthReflection: emptyGrowthReflection,
      id: "demo-meeting-dirk-being-discipled",
      notes: "",
      participantNames: ["Dirk Bond"],
      recommendedResources: [],
      review: buildDemoReview(),
      scheduledEndAt: daysAgoIso(9, 8),
      scheduledStartAt: daysAgoIso(9, 7),
      source: "table",
      tableRole: "being_mentored",
      tableRoleRecorded: true,
      title: "Coffee",
      type: "coffee",
      updatedAt: daysAgoIso(9, 9),
    },
    {
      conversationFlowKey: "none",
      conversationResponses: {},
      date: daysAgoIso(23, 7),
      fieldPersonIds: ["demo-person-dirk-bond"],
      growthReflection: emptyGrowthReflection,
      id: "demo-meeting-dirk-being-discipled-2",
      notes: "",
      participantNames: ["Dirk Bond"],
      recommendedResources: [],
      review: buildDemoReview(),
      scheduledEndAt: daysAgoIso(23, 8),
      scheduledStartAt: daysAgoIso(23, 7),
      source: "table",
      tableRole: "being_mentored",
      tableRoleRecorded: true,
      title: "Coffee",
      type: "coffee",
      updatedAt: daysAgoIso(23, 9),
    },
    {
      conversationFlowKey: "none",
      conversationResponses: {},
      ...
      fieldPersonIds: ["demo-person-dirk-bond"],
      growthReflection: emptyGrowthReflection,
      id: "demo-meeting-dirk-next",
      meetingStatus: "scheduled",
      notes: "",
      participantNames: ["Dirk Bond"],
      plannedDurationMinutes: 60,
      plannedEndAt: daysAgoIso(-2, 8),
      plannedStartAt: daysAgoIso(-2, 7),
      recommendedResources: [],
      review: buildDemoReview(),
      scheduledEndAt: daysAgoIso(-2, 8),
      scheduledStartAt: daysAgoIso(-2, 7),
      source: "table",
      tableRole: "being_mentored",
      tableRoleRecorded: true,
      title: "Coffee",
    ...
    /* Legacy meetings with no stored role (production shape). Dirk's has no
       confirmed Person direction, so it is Direction unresolved even though
       his recorded-role meetings above are Time invested in me. */
    {
      conversationFlowKey: "none",
      conversationResponses: {},
      date: daysAgoIso(4, 10),
      fieldPersonIds: ["demo-person-dirk-bond"],
      growthReflection: emptyGrowthReflection,
      id: "demo-meeting-dirk-legacy",
      notes: "",
      participantNames: ["Dirk Bond"],
      recommendedResources: [],
      review: buildDemoReview(),
      scheduledEndAt: daysAgoIso(4, 10, 45),
      scheduledStartAt: daysAgoIso(4, 10),
      source: "table",
      title: "Coffee",
      type: "coffee",
    ...
    },
    {
      conversationFlowKey: "none",
      conversationResponses: {},
      date: daysAgoIso(11, 10),
      fieldPersonIds: ["demo-person-marty-vanderzanden"],
      growthReflection: emptyGrowthReflection,
      id: "demo-meeting-marty-legacy",
      notes: "",
      participantNames: ["Marty Vanderzanden"],
      recommendedResources: [],
      review: buildDemoReview(),
      scheduledEndAt: daysAgoIso(11, 10, 90),
      scheduledStartAt: daysAgoIso(11, 10),
      source: "table",
      title: "Coffee",
      type: "coffee",
      updatedAt: daysAgoIso(11, 12),
    },
    {
      conversationFlowKey: "none",
      conversationResponses: {},
      date: daysAgoIso(8, 10),
      fieldPersonIds: ["demo-person-sam-lucas"],
      growthReflection: emptyGrowthReflection,
      id: "demo-meeting-sam-legacy",
      notes: "",
      participantNames: ["Sam Lucas"],
      recommendedResources: [],
      review: buildDemoReview(),
      scheduledEndAt: daysAgoIso(8, 10, 60),
      scheduledStartAt: daysAgoIso(8, 10),
      source: "table",
      title: "Coffee",
      type: "coffee",
      updatedAt: daysAgoIso(8, 12),
    },
    {
      conversationFlowKey: "none",
      conversationResponses: {},
      date: daysAgoIso(13, 10),
      fieldPersonIds: ["demo-person-austin-clifford"],
      growthReflection: emptyGrowthReflection,
      id: "demo-meeting-austin-legacy",
      notes: "",
      participantNames: ["Austin Clifford"],
      recommendedResources: [],
      review: buildDemoReview(),
      scheduledEndAt: daysAgoIso(13, 10, 60),
      scheduledStartAt: daysAgoIso(13, 10),
      source: "table",
      title: "Coffee",
      type: "coffee",
    ...
    },
    {
      conversationFlowKey: "none",
      conversationResponses: {},
      date: daysAgoIso(18, 10),
      fieldPersonIds: ["demo-person-tanner-kent", "demo-person-marty-vanderzanden"],
      growthReflection: emptyGrowthReflection,
      id: "demo-meeting-mixed-directions",
      notes: "",
      participantNames: ["Tanner Kent", "Marty Vanderzanden"],
      recommendedResources: [],
      review: buildDemoReview(),
      scheduledEndAt: daysAgoIso(18, 10, 75),
      scheduledStartAt: daysAgoIso(18, 10),
      source: "table",
      title: "Breakfast",
      type: "other",
      updatedAt: daysAgoIso(18, 12),
    },
    {
      conversationFlowKey: "none",
      conversationResponses: {},
    ...
    },
    {
      ...
      conversationResponses: {
        ...
        honorSabbath: "no",
        manifestationGifts: ["word_of_knowledge", "faith"],
        prayFastOften: "yes",
        preachGoodNews: "yes",
        relationshipWithJesus: 8,
        serviceGifts: ["encouragement"],
        significantOutcomes: ["discipleship_next_step", "connected_to_church_or_ministry"],
        spiritualGifts: "yes",
        tithe: "yes",
      },
  ...
  return {
    ...
    accountabilityCheckIns: [
      ...
      {
        checkInDate: daysAgoIso(1).slice(0, 10),
        createdAt: daysAgoIso(1),
        createdByUserId: null,
        durationMinutes: 25,
        followUp: null,
        generalUpdate: "Read the week's chapter and talked through the questions.",
        id: "demo-accountability-check-in-tanner-1",
        personId: "demo-person-tanner-kent",
        prayerNeeds: null,
        scheduleId: null,
        struggles: null,
      ...
      mentorRelationships: [
        {
          ...
          id: "demo-my-record-discipling-me-dirk",
          meetingRhythm: "2x/week",
          mentorName: "Dirk Bond",
          notes: null,
          phone: null,
          relationshipLabel: "Mentor",
          status: "active",
          updatedAt: daysAgoIso(64),
        },
        /* USA-251 conflict scenario: the Person record says Ryan is discipling
           Sam; this row says Sam is discipling Ryan. The Person is canonical,
           the report says so, and Sam's legacy meeting is Direction unresolved. */
        {
          createdAt: daysAgoIso(40),
          email: null,
          fieldPersonId: "demo-person-sam-lucas",
          id: "demo-my-record-discipling-me-sam",
          meetingRhythm: "Monthly",
          mentorName: "Sam Lucas",
          notes: null,
          phone: null,
          relationshipLabel: "Mentor",
          status: "active",
