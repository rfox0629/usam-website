...
function buildDosPreviewDemoData(): DosAppData {
  ...
  const meetingInputs = [
    ...
    },
    {
      ...
      fieldPersonIds: ["demo-person-naomi-lee"],
      growthReflection: {
        actionStep: "Keep reading John 4-6 before Thursday",
        followUpNeeded: false,
        mentorAssignment: null,
        scriptures: "John 3",
        whatGodTaught: null,
      ...
      notes: "Walked through the John reading plan together. Naomi shared that her family finally asked why she seems different lately.",
      participantNames: ["Naomi Lee"],
      recommendedResources: [],
      review: buildDemoReview(),
      source: "table",
