...
assert(client.includes("Connected Calendar") && client.includes("Availability Preview") && client.includes("This scheduling link checks your Google Calendar for conflicts."), "Calendar tab must explain the connected calendar and show an availability preview.");
