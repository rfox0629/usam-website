...
assert(client.includes("Word(s) of the Year"), "V2 overview should show the Word(s) of the Year card.");
assert(client.includes("Discipline") && client.includes("Assignment"), "V2 overview should show Ryan's current words.");
assert(client.includes("מוּסָר") && client.includes("שְׁלִיחוּת"), "V2 overview should render Hebrew word details.");
