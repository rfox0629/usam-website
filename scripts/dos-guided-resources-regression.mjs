...
assertIncludes(app, "session.chapters?.length", "Guided Journey accordion must render compact per-chapter subsections, including the two-chapter weeks in the final seven-week model.");
