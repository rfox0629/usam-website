...
| `dos.eyebrow` | `#2251E8` for section eyebrows (V10: eyebrows are blue); `#5A6473` for grey sub-eyebrows inside a section (Person "Right now") | `#6B7686`, tracked-caps labels | 5.2:1 |
...
3. Z-index ladder (documented, exhaustive): content 0 · sticky in-content 10/20 · FAB 10 · nav 30 · in-content popovers 40 · overlays (Person/Meeting/Circles detail) 50 · bottom sheets 80 · task screens 120 · full sheets 1000 · dialog 1100. Nothing else.
