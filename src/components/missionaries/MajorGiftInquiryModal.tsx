...
function subtleButtonClassName() {
  return "inline-flex min-h-12 w-full items-center justify-center border border-white/[0.22] bg-white/[0.02] px-7 py-3 text-center text-xs uppercase leading-5 tracking-[0.26em] text-stone-100 transition-all duration-300 hover:border-[#C2A14E] hover:bg-white/[0.04] hover:text-[#C2A14E] sm:w-auto";
}
              ...
              <form className="space-y-4" onSubmit={submitInquiry}>
                      ...
                      <label
                        className={`flex min-h-12 cursor-pointer items-center gap-3 rounded-xl border px-3 text-sm transition-colors ${
                          donationTypes.includes(option)
                            ? "border-[#C2A14E]/50 bg-usam-gold/10 text-stone-950"
                ...
                <label className="flex items-start gap-3 rounded-2xl border border-stone-200 bg-white p-4 text-sm leading-6 text-stone-700 shadow-sm">
                  <input
                    ...
                    className="mt-1 h-4 w-4 accent-[#C2A14E]"
