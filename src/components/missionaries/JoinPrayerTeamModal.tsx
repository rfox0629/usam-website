...
function buttonClassName(variant: JoinPrayerTeamModalProps["variant"] = "gold", customClassName?: string) {
  ...
  if (variant === "compact") {
    return "inline-flex min-h-10 items-center justify-center border border-[#C2A14E]/45 bg-[#C2A14E]/10 px-4 py-2 text-[11px] uppercase tracking-[0.2em] text-[#C2A14E] transition-colors hover:border-[#C2A14E] hover:bg-[#C2A14E]/15";
  }

  if (variant === "outline") {
    return "inline-flex min-h-12 w-full items-center justify-center border border-[#C2A14E]/55 bg-transparent px-7 py-3 text-center text-xs uppercase leading-5 tracking-[0.26em] text-[#C2A14E] transition-all duration-300 hover:border-[#C2A14E] hover:bg-[#C2A14E]/10 sm:w-auto sm:min-w-[220px]";
  }
    ...
    <>
      ...
      {isOpen ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 px-4 py-8">
          <div className="w-full max-w-2xl border border-stone-700 bg-[#0D0D0D] p-5 shadow-2xl md:p-7">
...
export function JoinPrayerTeamModal({
  ...
  return (
    <>
      ...
      {isOpen ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 px-4 py-8">
          <div className="w-full max-w-lg border border-stone-700 bg-[#0D0D0D] p-5 shadow-2xl md:p-7">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-[11px] uppercase tracking-[0.24em] text-[#C2A14E]" style={{ fontFamily: font.rajdhani, fontWeight: 700 }}>
                  Prayer Team
