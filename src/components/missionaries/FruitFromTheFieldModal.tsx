...
export function FruitFromTheFieldModal({
  ...
  return (
    <>
      <button
        className="inline-flex min-h-12 w-full items-center justify-center border border-usam-gold/65 bg-transparent px-7 py-3 text-center text-xs uppercase leading-5 tracking-[0.26em] text-white transition-all duration-300 hover:border-usam-gold hover:bg-usam-gold/12 sm:w-auto"
          ...
          <div className="max-h-[88vh] w-full max-w-4xl overflow-y-auto border border-stone-700 bg-[#090909] p-5 shadow-2xl md:p-7">
            ...
            <div className="mt-6 flex flex-col gap-3 border-y border-stone-800 py-4 sm:flex-row sm:items-center">
              <label className="block sm:w-56">
                ...
                <select
                  className="mt-2 min-h-10 w-full border border-stone-800 bg-[#050505] px-3 text-sm text-stone-100 outline-none focus:border-usam-gold"
