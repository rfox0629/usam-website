...
export const restorationSections: readonly RestorationSection[] = [
  ...
  },
  {
    fields: [
      ...
      { id: "marriageCount", label: "How many times have you been married?", type: "text" },
      { id: "childrenSatisfaction", label: "How satisfied are you with your current family regarding children?", options: satisfactionOptions, type: "radio" },
      { id: "favoredChild", label: "Which child do you favor the most and why?", type: "textarea" },
      { id: "childrenDifficulty", label: "Describe any difficulty you or your spouse may be having with your children.", type: "textarea" },
      { id: "childrenConfide", label: "Do you feel your children confide in you?", options: yesNoOptions, type: "radio" },
      { id: "spouseFirstName", label: "Spouse first name", type: "text" },
      { id: "yearsMarried", label: "Number of years married", type: "text" },
      { id: "ageWhenMarried", label: "My age when married", type: "text" },
      { id: "spouseAgeWhenMarried", label: "Spouse's age when married", type: "text" },
      { id: "fianceFirstName", label: "Fiance(e) first name", type: "text" },
      { id: "yearsEngaged", label: "Number of years engaged", type: "text" },
      { id: "spouseTraitsLike", label: "Describe traits you like about your spouse or fiance(e).", type: "textarea" },
      { id: "spouseTraitsDislike", label: "Describe traits you dislike about your spouse or fiance(e).", type: "textarea" },
      { id: "spouseExpectations", label: "What expectations do you have for your spouse or fiance(e)'s behavior?", type: "textarea" },
      { id: "spouseExpectationsMet", label: "Have your expectations been met?", options: yesNoOptions, type: "radio" },
      { id: "spouseExpectationsWhyNot", label: "If no, why not?", type: "textarea" },
      { id: "spouseConfide", label: "Can you confide in your spouse or fiance(e)?", options: yesNoOptions, type: "radio" },
      { id: "spouseSatisfaction", label: "How satisfied are you with them?", options: satisfactionOptions, type: "radio" },
      { id: "spouseFamilyRelationship", label: "Describe your relationship with your spouse or fiance(e)'s family.", type: "textarea" },
      { id: "marriageInterference", label: "Who, if anyone, has interfered with your marriage or plans? First names only.", type: "textarea" },
      { id: "exSpouseFirstName", label: "X-spouse first name", type: "text" },
      { id: "exYearsMarried", label: "Number of years married to x-spouse", type: "text" },
      { id: "exAgeWhenMarried", label: "My age when married to x-spouse", type: "text" },
      { id: "exSpouseAgeWhenMarried", label: "X-spouse's age when married", type: "text" },
      { id: "exTraitsLike", label: "Describe traits you liked about your x-spouse.", type: "textarea" },
      { id: "exTraitsDislike", label: "Describe traits you disliked about your x-spouse.", type: "textarea" },
      { id: "exFamilyRelationship", label: "Describe your relationship with your x-spouse's family.", type: "textarea" },
    ],
    id: "relationships",
    reviewNote: "Questions about favored children and family conflict may need trauma-informed wording before production.",
