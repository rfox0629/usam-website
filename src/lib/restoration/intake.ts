...
export const restorationSections: readonly RestorationSection[] = [
  ...
  },
  {
    fields: [
      ...
      { id: "stepfatherNameOccupation", label: "Stepfather's first name and occupation", type: "text", visibleWhen: { fieldId: "hadStepfather", equals: "Yes" } },
      ...
      { id: "stepmotherNameOccupation", label: "Stepmother's first name and occupation", type: "text", visibleWhen: { fieldId: "hadStepmother", equals: "Yes" } },
      ...
      { id: "stepfatherTraits", label: "Stepfather traits when you were young", options: parentTraitOptions, type: "checkbox-group", visibleWhen: { fieldId: "hadStepfather", equals: "Yes" } },
      { id: "motherTraits", label: "Mother traits when you were young", options: parentTraitOptions, type: "checkbox-group" },
      { id: "stepmotherTraits", label: "Stepmother traits when you were young", options: parentTraitOptions, type: "checkbox-group", visibleWhen: { fieldId: "hadStepmother", equals: "Yes" } },
      ...
      { id: "siblingsGrowingUp", label: "Describe your relationship with siblings growing up.", type: "textarea", visibleWhen: { fieldId: "hasSiblings", equals: "Yes" } },
      { id: "siblingsNow", label: "Describe your relationship with your siblings now.", type: "textarea", visibleWhen: { fieldId: "hasSiblings", equals: "Yes" } },
    ],
    id: "childhood",
  ...
  },
  {
    fields: [
      ...
      { id: "oppositeSexTraumaDetails", label: "Share only what feels important for the restoration team to understand", type: "textarea", visibleWhen: { fieldId: "oppositeSexTrauma", equals: "Yes" } },
      ...
      { id: "sameSexTraumaDetails", label: "Share only what feels important for the restoration team to understand", type: "textarea", visibleWhen: { fieldId: "sameSexTrauma", equals: "Yes" } },
      { id: "pornExposure", label: "Have you been exposed to pornographic material?", options: yesNoOptions, type: "radio" },
      { id: "pornExposureAge", label: "At what age were you first exposed?", type: "text", visibleWhen: { fieldId: "pornExposure", equals: "Yes" } },
