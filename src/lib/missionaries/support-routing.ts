...
export const supportRoutingModeDetails: Record<SupportRoutingMode, SupportRoutingModeDetail> = {
  ...
  household: {
    adminFallback: "Blank household giving links fall back to the default Church Center giving link.",
    adminRouting: "Monthly and one-time buttons use this household's giving URLs when provided.",
    adminSavedFields: "Saves support_mode as household plus this household's support goals and giving links.",
  ...
  household_nomination: {
    adminFallback: "If the target is missing, hidden, deleted, or has blank giving links, giving falls back to the General Fund/default Church Center link.",
    adminRouting: "Monthly and one-time buttons use the nominated household's giving URLs when available.",
