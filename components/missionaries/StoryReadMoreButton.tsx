        ...
        >
          ...
          >
            <button
              ...
              className="absolute right-4 top-4 z-20 flex h-10 w-10 items-center justify-center rounded-full border border-stone-300 bg-white text-sm uppercase tracking-[0.16em] text-stone-950 shadow-sm transition-colors hover:border-usam-gold hover:text-stone-950 md:right-5 md:top-5"
              style={{ fontFamily: font.rajdhani, fontWeight: 700 }}
